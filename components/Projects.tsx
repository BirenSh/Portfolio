            ...
            <div className="p-8">
              ...
              <div className="flex flex-wrap gap-2">
                {project.tech.map(tag => (
                  <span key={tag} className="px-3 py-1 bg-slate-50 dark:bg-slate-800 text-slate-500 dark:text-slate-400 text-xs font-medium rounded-full border border-slate-100 dark:border-slate-800 group-hover:border-indigo-500/30 group-hover:text-indigo-500 transition-all">
                    {tag}
                  </span>
                ))}
              </div>
